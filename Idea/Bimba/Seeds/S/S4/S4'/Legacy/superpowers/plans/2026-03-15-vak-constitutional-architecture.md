...
- `Idea/Bimba/Seeds/S/Legacy/resources/S/VAK-SUPERPOWERS-INTEGRATION-SPEC.md` — CANONICAL, 1893+ lines, the full system
- `Idea/Bimba/Seeds/S/Legacy/resources/S/VAK-HANDOVER.md` — distilled context, economic framing
- `Idea/Bimba/Seeds/S/Legacy/resources/S/ta-onta-anima-superpowers-vak-integration-spec.md` — early synthesis
...
```
Idea/Bimba/Seeds/S/Legacy/resources/S/VAK-SUPERPOWERS-INTEGRATION-SPEC.md  ← §1 (VAK grammar), §11 (ANIMA.md system),
...
**Files:**
- Create: `Idea/Bimba/Seeds/M/M4'/Legacy/plans/CLOCK-AND-NARA-SPECS/07-c-prime-vak-grammar-layer.md`
