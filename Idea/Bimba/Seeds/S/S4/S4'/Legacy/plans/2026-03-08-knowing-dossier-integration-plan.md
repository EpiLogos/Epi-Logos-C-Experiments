...
- Modify: `Idea/Bimba/Seeds/S/S0/S0'/Legacy/specs/S/S0-S0i-CLI-CORE.md`
- Test: `epi-cli/tests/core_knowing.rs`
...
```bash
git add docs/dev/S0'/README.md epi-logos-plugin/skills/epi-knowing.md Idea/Bimba/Seeds/S/S0/S0'/Legacy/specs/S/S0-S0i-CLI-CORE.md epi-cli/tests/core_knowing.rs
