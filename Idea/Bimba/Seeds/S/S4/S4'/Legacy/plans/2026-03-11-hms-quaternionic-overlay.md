...
**Goal:** Land the quaternionic overlay foundations described in `Idea/Bimba/Seeds/M/Legacy/specs/M/HMS-quaternionic-overlay.md` across M0, M1, and M3 without fabricating unresolved source data.
...
**Files:**
- Create: `Idea/Bimba/Seeds/S/S4/S4'/Legacy/plans/2026-03-11-hms-quaternionic-overlay.md`
- Reference: `Idea/Bimba/Seeds/M/Legacy/specs/M/HMS-quaternionic-overlay.md`
...
```bash
git add Idea/Bimba/Seeds/S/S4/S4'/Legacy/plans/2026-03-11-hms-quaternionic-overlay.md
...
```bash
git add epi-lib/include/m0.h epi-lib/include/m1.h epi-lib/include/m3.h epi-lib/src/m3.c epi-lib/test/m0/test_m0_rodata.c epi-lib/test/m1/test_m1.c epi-lib/test/m3/test_m3.c Idea/Bimba/Seeds/S/S4/S4'/Legacy/plans/2026-03-11-hms-quaternionic-overlay.md
