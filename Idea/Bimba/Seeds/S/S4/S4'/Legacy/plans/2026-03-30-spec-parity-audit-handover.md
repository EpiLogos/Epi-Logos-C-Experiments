---
coordinate: "S4'-3"
c_0_source_coordinates: ["/docs/prompts/2026-03-30-spec-parity-audit-handover.md"]
c_4_artifact_role: "prompt"
c_3_created_at: "2026-03-30"
...
Read `Idea/Bimba/Seeds/S/S4/S4'/Legacy/plans/2026-03-30-critical-gap-resolution-plan.md` to understand what was just completed, then read the spec files in `docs/plans/CLOCK-AND-NARA-SPECS/` in order. The canonical invariants file (`00-`) is the invariant ground — any violation of its constraints anywhere in the codebase is a P0 gap. The holographic validation matrix (`10-`) provides an existing cross-check structure worth comparing against actual code state.
