...
**Design Spec:** `Idea/Bimba/Seeds/S/S0/S0'/Legacy/specs/S/S0-QV-PIPELINE-AND-PLUGIN.md`
...
- Modify: `Idea/Bimba/Seeds/S/S0/S0'/Legacy/specs/S/S0-S0i-CLI-CORE.md` (add QV pipeline section)
...
```bash
git add docs/dev/S0\'/README.md Idea/Bimba/Seeds/S/S0/S0'/Legacy/specs/S/S0-S0i-CLI-CORE.md ~/.claude/skills/epi-knowing.md
