...
- Done: S3 gateway now owns the dispatch route ownership table for every advertised gateway method and extension route family; S0 consults that table while remaining the live executable server adapter.
