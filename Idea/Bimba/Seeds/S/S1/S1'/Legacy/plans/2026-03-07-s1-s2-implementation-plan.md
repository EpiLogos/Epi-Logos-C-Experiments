...
**Specs:**
- `Idea/Bimba/Seeds/S/S1/S1'/Legacy/specs/S/S1-S1i-OBSIDIAN.md` — vault ontology, frontmatter schema, T-coordinate routing
- `Idea/Bimba/Seeds/S/S2/S2'/Legacy/specs/S/S2-S2i-GRAPH.md` — Neo4j schema, seed data, Redis tiers, retrieval, port map
