...
This file records the source corpus used to crystallise [[S1']] as a specification-level authority in [S1'.md](/Users/admin/Documents/Epi-Logos%20C%20Experiments/Idea/Bimba/World/Types/Coordinates/S/S'/S1'/S1'.md).

Primary canon used for [[S1']]:

| Source | Location | Role in conclusion |
|---|---|---|
| [[S1']] | `/Users/admin/Documents/Epi-Logos/Idea/Bimba/World/S1'.md` | Old high-level form for [[Content API]] / [[Monadological Mapping]] |
| [[S1'Cx]] | `/Users/admin/Documents/Epi-Logos/Idea/Bimba/World/S1'Cx.md` | C-level manifestations at S1' used to recover [[C0]]-[[C5]] mapping |
...
- [[S1']] is the formal content law of the vault, not merely a CRUD wrapper.
- The six monadological operations belong to the normative API surface.
- [[CT]] and [[CT']] are constitutive of content law; templates are frozen processes, not convenience snippets.
- [[Daily Note]] is the metatemplate of homebase context; [[NOW]] is its bounded child form.
- [[CT4b']] is the master temporal-fractal template family for shared day-context operations.
- [[S1'Cx]] belongs conceptually inside [[S1']], even where old docs split it out.
...
- a dedicated seed for each monad operation (`init_ground`, `parse_form`, `read_content`, `structure_pattern`, `coordinate_context`, `integrate_links`)
- a standalone [[CT4b']] / [[Daily Note]] / [[NOW]] lineage seed if the homebase architecture keeps expanding
- an explicit S1' -> S2' parity seed once vault-to-graph mapping is crystallised beyond planning language
