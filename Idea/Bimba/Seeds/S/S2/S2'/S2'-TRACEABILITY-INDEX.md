...
c_0_source_coordinates: ["[[S2']]", "[[S2'Cx]]", "[[S2-S2i-GRAPH]]", "[[S-STACK-INTEGRATION]]", "[[2026-02-26-epi-logos-canonical-system-plan]]", "[[2026-03-07-s1-s2-implementation-plan]]", "[[2026-03-08-knowing-graph-convergence-plan]]", "[[2026-03-10-semantic-graph-lifecycle]]"]
---
...
This file records the source corpus used to crystallise [[S2']] as a specification-level authority in [S2'.md](/Users/admin/Documents/Epi-Logos%20C%20Experiments/Idea/Bimba/World/Types/Coordinates/S/S'/S2'/S2'.md).
...
| `epi core knowing \"S2'\" --json` and `epi graph doctor --json` | Runtime CLI reads | Consulted initially, then explicitly subordinated after user correction because they report present-state surfaces rather than the true eventual shape |

## #5 Integration

Conclusions drawn for [[S2']]:

- [[S2']] is the coordinate-aware graph law above [[S2]], not the raw database substrate.
- [[S2']] is the proper home of [[QL Graph]], lawful coordinate identity, retrieval envelopes, cache law, and namespace discipline.
- [[Day]] and [[NOW]] lineage belongs inside the graph-law contract, not as an afterthought layered on later.
- [[Indra's Net]] and graph monadology are part of the target doctrine, not decorative metaphors.
- Runtime/code evidence was used only as corroboration; the decisive authority was the planned final architecture.
...
- a dedicated seed for retrieval-law, cache-law, and namespace-law as separate but coupled surfaces
- a standalone seed for [[Day]] / [[NOW]] graph lineage and its relation to [[Hen]], [[Khora]], and [[Chronos]]
