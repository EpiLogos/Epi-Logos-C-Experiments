...
This file records the source corpus for [[S5]] as world-boundary service layer. The old S5 materials and [[S5-S5i-SYNC]] preserve useful #5 intuition, but the current S5/S5' target is broader than sync, Notion, or external automation.
...
| `epi-cli/src/book/`, `epi-cli/src/notebook/`, `epi-cli/src/vimarsa/`, `epi-cli/src/kbase/` | `epi-cli/src/` | Current world-return and knowledge-surface evidence |

## #5 Integration

Conclusions drawn for [[S5]]:

- [[S5]] is the integral world-boundary, not merely [[Notion]] or sync.
- [[Nara]]/M4, Gnosis, RAG-Anything, NotebookLM, Vimarsa/kbase, book ingestion, Bimba navigation, Graphiti usage, and external publication all live here as world-return functions.
- [[Graphiti]] architecture remains [[S3']], while S5 owns record/search invocation, usage patterning, disclosure, and meaning of episodic memory.
- The [[epi-logos plugin]] is the planned S5/S5' resource and skill spine. Current external automations remain secondary connectors.
- S5 implementation must prove real parsing, retrieval, ingestion, and publication/return behavior rather than mock-only command shape.

## #0 Ground

Future S5 implementation work should read this file together with [[S5'-TRACEABILITY-INDEX]] before touching Nara, Gnosis, kbase/Vimarsa, NotebookLM, book ingestion, Graphiti usage, external connectors, or S5 API methods.
