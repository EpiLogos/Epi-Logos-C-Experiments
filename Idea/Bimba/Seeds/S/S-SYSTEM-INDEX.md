...
| `s3'.temporal/day/kairos/presence/context` | [[S3']] | 3, 6, 7, 9 | gate tick/session store, vault day helpers, SpacetimeDB bridge; Redis context not yet separated | `Body/S/S0/epi-cli/src/gate/runtime.rs`, `gate/spacetimedb_bridge.rs`, `vault/kairos.rs`, `nara/kairos.rs`, `Body/S/S3/epi-spacetime-module` | `gate_runtime_state.rs`, `gate_tick_health.rs`, `gate_spacetimedb_bridge.rs`, `nara_tick12_contract.rs` | partial | Build `Body/S/S3/redis-context`; separate S3' temporal Redis from S2 cache Redis |
