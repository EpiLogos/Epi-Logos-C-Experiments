...
**Status:** Historical runtime plan with live implementation notes. Canonical field shapes and precedence are governed by `Idea/Bimba/Seeds/M/M4'/Legacy/plans/CLOCK-AND-NARA-SPECS/00-canonical-invariants.md`, `Idea/Bimba/Seeds/M/M4'/Legacy/plans/CLOCK-AND-NARA-SPECS/00-spec-harmonization-plan.md`, `Idea/Bimba/Seeds/M/M4'/Legacy/plans/CLOCK-AND-NARA-SPECS/09-cosmic-clock-plugin-tui-spec.md`, and the dataset-bridge coordination set.
...
28. **Spec:** `Idea/Bimba/Seeds/M/M4'/Legacy/specs/M/M4-nara-subtle-body-map.md` — full Archetypal-Citta spec with 10 USs
