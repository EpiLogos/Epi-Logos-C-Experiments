...
**The implementer** should follow the spec `Idea/Bimba/Seeds/M/M0'/Legacy/specs/M/M0-anuttara-language-architecture.md` for every LUT value. The formulation strings come from `docs/datasets/nodes_anuttara.json`.
...
After implementation, verify against `Idea/Bimba/Seeds/M/M0'/Legacy/specs/M/M0-anuttara-language-architecture.md`:
