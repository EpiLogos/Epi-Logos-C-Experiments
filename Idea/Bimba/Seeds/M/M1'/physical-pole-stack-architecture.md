...
status: "kernel-canon"
updated: "2026-05-19"
domain: "physical-pole-engine"
description: "Specification of the 1-2-3 triplet (torus, solar-chakral, codon-clock) as the computational engine pole of the kernel. Tauri v2, Bevy, wgpu rendering architecture. The torus at #1-5 (Paramasiva) is the primary visualisation substrate."
depends_on:
