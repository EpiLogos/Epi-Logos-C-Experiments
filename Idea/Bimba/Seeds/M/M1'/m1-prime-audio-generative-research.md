...
- `Idea/Bimba/Seeds/M/M1'/m1-prime-paramasiva-instrument.md` — long architectural derivation. It remains useful for the six M1-0'..M1-5' strata, proposed `m1_prime_*` APIs, 8+4 bridge, rate-band concept, strike-event flow, M2'/M3 seams, and testing invariants. Its older claim that M1' owns frequency genesis should be read through the newer domain spec: M1' renders and externalizes the kernel-owned frequency profile.
