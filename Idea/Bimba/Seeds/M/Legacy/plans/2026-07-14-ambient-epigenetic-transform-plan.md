...
- **Open (next):** P4 rotational/3-matrix seam (HMS §V–VI), P5 codon→RNA→amino-acid + Major-Arcana sequences, P6 carrier + M4 sink live-wire, P2 richer natal reference. Phase 0 (cycle-3 track amendments) landed earlier this session (`8a2e1dab`).
