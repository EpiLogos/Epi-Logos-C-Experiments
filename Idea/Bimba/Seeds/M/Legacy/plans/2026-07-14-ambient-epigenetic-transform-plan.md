...
- **Open (next):** three-site TS unification (`recognition-layer-slot::composeQComposed`) + delete the epi-cli duplicate law; then P2 richer natal reference, P4 rotational/3-matrix seam, P5 codon→RNA→amino-acid + Major-Arcana sequences, P6 carrier + M4 sink live-wire. Phase 0 (cycle-3 track amendments) landed earlier this session (`8a2e1dab`).
