...
4. **T40.3 — Complete and verify the Phase-J landing invariant across the three target canon files + DR-M3-6 amendment**
   ...
   Depends on Track 00 Tranche 3.
   Verify: each of the three target files carries BOTH inline marker(s) AND a `canon_updates_landed` entry per landed row; T40.2's lint passes green; verifier ≠ closer.
