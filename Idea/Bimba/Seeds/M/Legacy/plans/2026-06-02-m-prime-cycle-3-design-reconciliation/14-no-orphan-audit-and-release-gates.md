...
| **`anuttara_trace(output, sensitivity, depth)` API** | UX §2.3 named; M5-claimed with M0-substrate-owner requirement; read-only contemplative-offering only; M0 substrate writes via governed routed-write per DR-M0-1; no separate carrier lands | Tranche **06.6** (CLOSED / REVERIFIED 2026-07-16) |
