...
Generated: 2026-05-31T21:55:59.506Z

## Task

- **ID:** 01.T0
- **Title:** Baseline Contract Inventory
- **Track:** 01-kernel-bridge-and-s0-foundation.md
- **Computed status:** ready
- **Write scopes:** Body/S/S0/**, Body/S/S0/epi-lib/test/infrastructure/test_pointer_web.c
...
- `Body/S/S0/portal-core/Cargo.toml`
