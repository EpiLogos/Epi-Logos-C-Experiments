...
1. **T0 - Integration Decision Gate And Local Harness Topology.**
   ...
   - `10-t0-validate.mjs` validates the artifacts and emits machine-readable local readiness with `node Idea/Bimba/Seeds/M/Legacy/plans/2026-05-31-mprime-and-sprime-implementation-tracks/10-t0-validate.mjs --readiness`.
