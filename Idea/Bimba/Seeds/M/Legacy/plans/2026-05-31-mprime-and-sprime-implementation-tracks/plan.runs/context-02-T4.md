# M-Dev Context Pack - 02.T4

Generated: 2026-06-01T12:24:16.714Z

## Task

- **ID:** 02.T4
- **Title:** Dataset population from existing corpus
- **Track:** 02-s2-bimba-map-population.md
- **Computed status:** ready
- **Write scopes:** Body/S/S2/**, docs/datasets, docs/datasets/low-detail/**
...
- 02.T3 - Canonical coordinate seed baseline (02-s2-bimba-map-population.md)
