...
# domain: "M3 Mahamaya — gamma matrix representation"
# description: "Six explicit 8x8 real gamma matrices for Cl(4,2) with signature (-,+,+,+,+,-); hexagram-as-operator matrices; trigram spinor action; split quaternion eigenstructure; C/Rust int8 export"
