---
coordinate: "M4'-1"
c_0_source_coordinates: ["/docs/prompts/nara-runtime-impl.md"]
...
**Spec:** `Idea/Bimba/Seeds/S/S3/S3'/Legacy/plans/2026-03-10-nara-runtime-full-plan.md` (v2.1)
...
```
1.  Idea/Bimba/Seeds/S/S3/S3'/Legacy/plans/2026-03-10-nara-runtime-full-plan.md     — canonical plan, all sections
2.  Idea/Bimba/Seeds/M/M4'/Legacy/specs/M/M4-nara-personal-interface.md           — M4 philosophy + C struct ground
3.  Idea/Bimba/Seeds/M/M4'/Legacy/specs/M/M4-nara-subtle-body-map.md              — identity data flowing to frontend
