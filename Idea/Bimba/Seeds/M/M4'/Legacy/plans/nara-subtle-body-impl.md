---
coordinate: "M4'-2"
c_0_source_coordinates: ["/docs/prompts/nara-subtle-body-impl.md"]
...
**Spec:** `Idea/Bimba/Seeds/M/M4'/Legacy/specs/M/M4-nara-subtle-body-map.md` (v1.0)
...
```
1. Idea/Bimba/Seeds/M/M4'/Legacy/specs/M/M4-nara-subtle-body-map.md               — canonical spec, all sections
2. Idea/Bimba/Seeds/M/M4'/Legacy/specs/M/M4-nara-personal-interface.md             — FR 2.4.7 Elemental Throughline
