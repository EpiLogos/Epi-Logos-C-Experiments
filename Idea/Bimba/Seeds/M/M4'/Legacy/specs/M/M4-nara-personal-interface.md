...
> precedence now live in `Idea/Bimba/Seeds/M/M4'/Legacy/plans/CLOCK-AND-NARA-SPECS/00-canonical-invariants.md`,
> `Idea/Bimba/Seeds/M/M4'/Legacy/plans/CLOCK-AND-NARA-SPECS/00-spec-harmonization-plan.md`, and
> `Idea/Bimba/Seeds/M/M4'/Legacy/plans/CLOCK-AND-NARA-SPECS/09-cosmic-clock-plugin-tui-spec.md`. Where this file still
...
*Canonical Ground:* `/Users/admin/Documents/Epi-Logos C Experiments/Idea/Bimba/Seeds/M/M4'/Legacy/specs/M/M4-nara-personal-interface.md`
*Incorporates:* Gemini architectural review (lines 785-1106 of `Idea/Bimba/Seeds/S/S2/S2'/Legacy/specs/gemini-spec-M-branch-updates-refinements.md`)
