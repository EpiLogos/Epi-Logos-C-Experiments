...
| ST2 | `Idea/Bimba/Seeds/S/S4/S4-SPEC.md` derivation notes + VAK Gate section | Reference the canonical VAK source files (`docs/resources/S/VAK-HANDOVER.md`, `docs/plans/2026-04-04-omx-vak-skill-fork-plan.md`, `docs/superpowers/plans/2026-04-04-anima-vak-gate-skill-injection.md`) so the spec doesn't drift again. | Source-traceability. |
