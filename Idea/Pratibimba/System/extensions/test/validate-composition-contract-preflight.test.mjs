...
const composition = JSON.parse(
  readFileSync(
    join(repoRoot, "Idea/Pratibimba/System/extensions/contracts/08-t0-composition-contract-preflight.json"),
    "utf8"
  )
);
...
const seven = JSON.parse(
  readFileSync(
    join(repoRoot, "Idea/Pratibimba/System/extensions/contracts/07-t0-extension-contract-preflight.json"),
    "utf8"
  )
);
