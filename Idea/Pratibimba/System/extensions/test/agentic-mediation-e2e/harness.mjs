    ...
    return {
        ...
        substrate_anchors: {
            ...
            agentic_control_room_run_model:
                'Idea/Pratibimba/System/extensions/agentic-control-room/src/common/run-model.ts',
            body_lite_deep_link_intents:
                'Idea/Pratibimba/System/extensions/body-lite-surface/src/common/deep-link-intents.ts',
