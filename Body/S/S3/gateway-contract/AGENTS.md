...
- `S2_GRAPH_LIST_METHOD` / `S2_GRAPH_GATEWAY_EXPOSED_METHODS` — registers `s2.graph.list` as the read-only [[M0]] residual-browser route and keeps dispatch-plan and live hello advertisement in parity.
