...
use crate::{
    KHORA_SESSION_START_METHOD, M1_SPANDA_HALF_TURN_METHOD, M1_SPANDA_HOLD_METHOD,
    M1_SPANDA_RELEASE_METHOD, M1_SPANDA_STEP_METHOD, M1_SPANDA_WALK_TO_METHOD,
    NARA_TRANSFORM_ADVANCE_METHOD, NARA_TRANSFORM_START_METHOD, PORTAL_EVENT_NAMES,
    ...
    S0_PRIME_VERIFIER_VALIDATE_MEMBERSHIP_METHOD, S2_CODON_AA_LOOKUP_METHOD,
    S2_CODON_SCALAR_REF_READ_METHOD, S5_EPII_DEPOSIT_LIST_METHOD,
    ...
    S2_GRAPH_ONTOLOGY_RELOAD_METHOD, S2_GRAPH_PROMOTION_COMMIT_METHOD,
    S2_GRAPH_PROMOTION_DRY_RUN_METHOD, S2_GRAPH_RELATION_FAMILY_LIST_METHOD,
    S2_GRAPH_SEED_SNAPSHOT_METHOD, S5_GNOSTIC_MUSICAL_TRANSCRIPT_METHOD,
    S5_ORACLE_ICHING_CAST_METHOD, S5_TUNE_AUDIT_READ_METHOD, S5_TUNE_LOCK_TOGGLE_METHOD,
    S5_TUNE_PROPOSALS_LIST_METHOD, S5_TUNE_PROPOSALS_RESOLVE_METHOD, S5_TUNE_PROPOSE_METHOD,
    S5_TUNE_REGISTRY_GET_METHOD, S5_TUNE_REGISTRY_LIST_METHOD, S5_TUNE_REGISTRY_SET_METHOD,
    VAULT_DAY_ENSURE_METHOD,
};
...
pub const METHOD_NAMES: &[&str] = &[
    ...
    VAULT_DAY_ENSURE_METHOD,
    KHORA_SESSION_START_METHOD,
    "s2.graph.query",
    "s2.graph.node",
    S2_GRAPH_LIST_METHOD,
    S2_CODON_AA_LOOKUP_METHOD,
    S2_CODON_SCALAR_REF_READ_METHOD,
    // 26.T26.10 — the Evidence fold's feed: deposits read back out.
    S5_EPII_DEPOSIT_LIST_METHOD,
    ...
    "m2.cymatic_invert",
    crate::KERNEL_BRIDGE_M2_EPOGDOON_PROJECTION_METHOD,
    crate::KERNEL_BRIDGE_M2_CYMATIC_MONOPOLY_STATE_METHOD,
    crate::KERNEL_BRIDGE_M2_PLANETARY_ELEMENTAL_WEIGHTS_METHOD,
    crate::KERNEL_BRIDGE_M3_LENS_CODON_BINARY_METHOD,
    crate::KERNEL_BRIDGE_M3_LENS_FIELD_METHOD,
    NARA_TRANSFORM_START_METHOD,
    NARA_TRANSFORM_ADVANCE_METHOD,
    ...
    "s1'.vault.move_file",
    crate::S1_BASE_ENSURE_METHOD,
    crate::S1_Q_ARTICULATION_ACCEPT_METHOD,
