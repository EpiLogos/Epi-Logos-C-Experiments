...
- `src/dispatch.rs` — RPC method dispatch (largest module), including [[M4]]/[[S4]] Nara extension routes such as protected session protein handles, headless contemplation close, and route metadata for S2 graph-service gateway exposure.
