...
- **M2 Parashakti** (`Idea/Bimba/Map/datasets/parashakti-deep/`): the 36 decan nodes (coordinates
...
| `Idea/Bimba/Map/datasets/parashakti-deep/nodes-full-detail.json` | M2 source: decan `bodyPart`, `herbalism_herbs`, `planetaryRuler`, `zodiacSign` |
| `Idea/Bimba/Map/datasets/parashakti-deep/relations.json` | M2 source: `PLANETARY_RESONANCE` edges → `PLANET_CHAKRA` |
