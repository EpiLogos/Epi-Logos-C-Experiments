...
#[test]
fn omnipanel_contract_surfaces_alias_team_and_cmux_metadata() {
    ...
    assert!(hello.session_metadata.contains(&"teamId"));
    assert!(hello.session_metadata.contains(&"teamRole"));
    assert!(hello.session_metadata.contains(&"orchestrationKind"));
    assert!(hello.session_metadata.contains(&"cmuxWorkspace"));
    assert!(hello.session_metadata.contains(&"cmuxSurface"));
    assert!(hello.session_metadata.contains(&"cmuxPaneId"));
}
