//! Anuttara symbolic-skill surface.
//!
//! Implements two operations from mental-pole mechanics §6: parsing an
//! Anuttara symbolic string into a typed [`AnuttaraDiagnostic`], and
//! shaping a reflection prompt for a future LLM-backed skill to
//! consume. The reflection prompt is deterministic and structured so
//! that swap-in to an LLM call leaves the typed contract intact.
