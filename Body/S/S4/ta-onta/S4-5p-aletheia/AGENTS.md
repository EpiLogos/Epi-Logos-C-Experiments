...
- `modules/` — implementation units (anansi-lineage, anansi-elo-index, moirai-rehear, moirai-fair-comparison, janus-doorway, janus-threshold, mercurius-translation, mercurius-elo, agora-staging, zeithoven-autoresearch, sophia-ingest, thought-vak, gate-trigger, chronos-integration, hen-integration, coordinate-loop)
