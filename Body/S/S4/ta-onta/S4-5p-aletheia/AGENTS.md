...
- `modules/` — implementation units (anansi-lineage, moirai-rehear, janus-doorway, mercurius-translation, agora-staging, zeithoven-autoresearch, sophia-ingest, thought-vak, gate-trigger, chronos-integration, hen-integration, coordinate-loop)
