...
| CT | CT3 Pattern |
| CPF | `(4.0/1-4.4/5)` unless explicitly dialogical pattern-discovery is needed |
| CP | 4.3 Pattern |
| CFP | CFP0 single-pattern reading, CFP3 fusion when multiple pattern recognizers must converge |
| CS | Day pattern formation, Night' P3' recurrence discernment |
