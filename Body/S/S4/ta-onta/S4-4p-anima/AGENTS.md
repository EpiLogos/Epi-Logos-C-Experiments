...
- `modules/` — per-agent dispatch/route/hook units (nous-clearing, logos-scope, eros-route, mythos-pattern, psyche-continuity, sophia-hook/synthesis, moirai-dispatch, skill-registry, dispatch-validate, anima-invoke-payload)
