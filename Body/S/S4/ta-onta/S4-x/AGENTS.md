...
## Ownership
- `skills/nara-voice-training/` — local-only LoRA adaptation over journal, dream, and phone-writing corpus; emits checkpoint references for `E4PersonalInputs.lora_checkpoint`.
