...
- `tests/` — includes `flow_watcher.test.ts` real-filesystem mode acceptance plus NOW/session/sync/Sophia/result-wake suites
...
## Verification
- `node --test Body/S/S4/ta-onta/S4-0p-khora/tests/*.test.ts`
