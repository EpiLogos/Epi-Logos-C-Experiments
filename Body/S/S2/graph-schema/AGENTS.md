...
- `tests/` — schema contract tests: `label_registry.rs`, `property_registry.rs`, `relationship_registry.rs`, `code_provenance_properties.rs`, `coordinate_prefix_properties.rs`, `track_02_t1_convergence.rs`.
