...
pub const LABEL_SPECS: &[GraphLabelSpec] = &[
    GraphLabelSpec {
        label: "Coordinate",
        coordinate_home: CoordinateHome::S2Compat,
        source_family: "compatibility",
        compatibility: true,
    },
    GraphLabelSpec {
        label: "VaultArtifact",
        coordinate_home: CoordinateHome::S1Compat,
        source_family: "compatibility",
        compatibility: true,
    },
    GraphLabelSpec {
    ...
    GraphLabelSpec {
        label: "DailyNote",
        coordinate_home: CoordinateHome::S1_4,
        source_family: "vault",
        compatibility: false,
    },
    GraphLabelSpec {
    ...
    GraphLabelSpec {
        label: "VakCoordinate",
        coordinate_home: CoordinateHome::VAK,
        source_family: "coordinate",
        compatibility: false,
    },
    GraphLabelSpec {
    ...
    GraphLabelSpec {
        label: GNOSTIC_LABEL,
        coordinate_home: CoordinateHome::S5,
