...
- Shared bridge capabilities are the JSON contract's `sharedBridgeAdapter.requiredCapabilities`, including `s2.parashaktiCorrespondences`, `kernelBridge.m2.planetaryElementalWeights()`, `kernelBridge.m2.cymaticMonoPolyState(address72)`, and `kernelBridge.m3.bioquaternionTranscription(codon)` for bridge-owned projection objects.
