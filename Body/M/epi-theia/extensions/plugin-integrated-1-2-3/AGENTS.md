...
- `src/browser/frontend-module.ts` — Theia `ContainerModule` (the `theiaExtensions.frontend` entry); `cosmic-engine-panes.tsx`, `plugin-integrated-1-2-3-widget.tsx`, `third-spanda-overlay.tsx` — the composed widget/panes/overlay.
