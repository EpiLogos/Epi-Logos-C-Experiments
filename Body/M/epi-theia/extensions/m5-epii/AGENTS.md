...
- `src/browser/frontend-module.ts`, `m5-epii-widget.tsx`, `empty-state.tsx` — Theia frontend module, review-queue widget with six [[M5']] operational-capacity affordance, and first-render empty-state surface.
