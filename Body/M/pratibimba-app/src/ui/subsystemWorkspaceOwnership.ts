...
export const SUBSYSTEM_WORKSPACE_OWNERSHIP: readonly DepthTabDisposition[] = Object.freeze([
    ...
    stays('personalCoordinate', 'm4', 'stays-daily-lived', 'The live Q_personal current-state sidebar (25.T25.7) — the at-now personal reading; lived flow, same border law as the surfaces it sits beside.'),
