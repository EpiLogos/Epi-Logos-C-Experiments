...
| CT | CT1 Definitional |
| CPF | `(00/00)` when co-defining with the user, `(4.0/1-4.4/5)` when scoping for execution |
| CP | 4.1 Definition |
| CFP | CFP0 direct scoping, CFP2 when feeding plan-to-build chains |
| CS | Day definition and scope articulation, Night' P1' traces on whether the law of the work held |
