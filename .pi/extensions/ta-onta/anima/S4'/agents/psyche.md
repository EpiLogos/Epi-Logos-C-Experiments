...
| Layer | Value |
|-------|-------|
| CF | `(4.0/1-4.4/5)` — CT4b' fractal doubling |
| CT | CT4 Contextual |
| CPF | `(4.0/1-4.4/5)` Ralph OR `(00/00)` Ouroboros (evaluate before every task) |
| CP | 4.4 Context |
| CFP | Dispatches CFP0-CFP5, especially CFP1/CFP2/CFP3 as the coordinating patient |
| CS | Reads runtime CS state for Day/Night' directionality and hands Night' availability to Aletheia |
