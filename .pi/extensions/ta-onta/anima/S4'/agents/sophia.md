...
| CT | CT5 Integrative |
| CPF | `(4.0/1-4.4/5)` when completing an autonomous pass; may receive `(00/00)` insight returns from dialogical work |
| CP | 4.5 Integration |
| CFP | CFP0 synthesis, CFP3 Night' fusion with Moirai, CFP5 meta-return into the next cycle |
| CS | Night' specialist; receives CS transitions into `night_prime` and emits Möbius return back into Day |
