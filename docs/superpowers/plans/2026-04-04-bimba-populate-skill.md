...
- `docs/superpowers/specs/2026-04-04-neo4j-m-branch-coordinate-schema-population-design.md` — full schema spec
...
**Plan complete and saved to `docs/superpowers/plans/2026-04-04-bimba-populate-skill.md`.**
