...
> payload routing now lives in `docs/plans/CLOCK-AND-NARA-SPECS/00-canonical-invariants.md`,
> `docs/plans/CLOCK-AND-NARA-SPECS/00-spec-harmonization-plan.md`, and the dataset-bridge docs.
...
**Updated:** 2026-04-11 — Fibonacci Ground (§-1) added. See also:
  ...
  `docs/plans/CLOCK-AND-NARA-SPECS/02-16-lenses-backbone-temporal.md §0`.
