...
File: `docs/specs/M/M0-anuttara-language-architecture.md`
...
File: `docs/specs/M/M1-paramasiva-mathematical-dna.md`
...
File: `docs/specs/M/M2-parashakti-vibrational-architecture.md`
...
File: `docs/specs/M/M3-mahamaya-symbolic-transcription.md`

**NOT PATCHED.** M3 is the gold standard. All other specs align to M3.

### M4 — Nara Personal Interface

File: `docs/specs/M/M4-nara-personal-interface.md`
...
File: `docs/specs/M/M5-epii-holographic-integration.md`
