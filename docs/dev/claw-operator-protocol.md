...
- `docs/plans/2026-04-03-omx-pleroma-claw-runtime-migration.md` — full migration plan
- `docs/specs/S/S4/2026-04-03-omx-pleroma-claw-authority-matrix.md` — authority matrix
