...
*Part of the QL Harmonic Mathematics package. References:*
- *`ql_harmonic_mathematics_v2.md` — 4+2 frame, genesis, phase spaces, master table, clock, lenses*
- *`ql_clifford_consolidation.md` — Cl(4,2) algebra, gamma matrices, validation status, implementation spec*
- *`ql_transcriptional_bridge.md` — T→U quintessence, 37/27/101 structure, genetics as formal medium*
- *`clifford_computation.py` + `gamma_matrices.py` — verified computational substrate*
