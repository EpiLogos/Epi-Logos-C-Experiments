...
**Files:**
- Create: `docs/specs/S/S4/2026-04-03-omx-pleroma-claw-authority-matrix.md`
- Modify: `docs/specs/S/S4/S4-S4i-PI-SKILLS-AND-PLUGIN-SYSTEM.md`
- Modify: `docs/specs/S/S4/2026-03-08-superpowers-pleroma-source-inventory.md`
...
```bash
git add docs/specs/S/S4/2026-04-03-omx-pleroma-claw-authority-matrix.md docs/specs/S/S4/S4-S4i-PI-SKILLS-AND-PLUGIN-SYSTEM.md docs/specs/S/S4/2026-03-08-superpowers-pleroma-source-inventory.md epi-cli/tests/agent_docs.rs
...
**Files:**
- Create: `docs/specs/S/S4/2026-04-03-omx-pleroma-port-matrix.md`
- Modify: `docs/specs/S/S4/2026-03-08-pleroma-canonical-brief.md`
- Modify: `docs/specs/S/S4/S4-EXTENSION-ARCHITECTURE.md`
- Test: `epi-cli/tests/agent_docs.rs`
...
```bash
git add docs/specs/S/S4/2026-04-03-omx-pleroma-port-matrix.md docs/specs/S/S4/2026-03-08-pleroma-canonical-brief.md docs/specs/S/S4/S4-EXTENSION-ARCHITECTURE.md epi-cli/tests/agent_docs.rs
...
- Modify: `docs/specs/S/S4-S4i-PI-AGENT.md`
...
```bash
git add docs/dev/pi-operator-protocol.md docs/specs/S/S4-S4i-PI-AGENT.md .pi/extensions/ta-onta/pleroma/CONTRACT.md epi-cli/src/agent/runtime.rs epi-cli/src/agent/spawn.rs epi-cli/tests/agent_claw_runtime.rs epi-cli/tests/agent_native_pi_contract.rs
