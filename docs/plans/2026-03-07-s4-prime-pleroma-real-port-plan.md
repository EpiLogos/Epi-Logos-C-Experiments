...
**Files:**
- Create: `docs/specs/S/S4/S4i-PLEROMA-PORT-MATRIX.md`
- Modify: `docs/plans/2026-03-07-s4-prime-pleroma-real-port-plan.md`
...
fn pleroma_port_matrix_lists_all_capability_families() {
    let text = std::fs::read_to_string("docs/specs/S/S4/S4i-PLEROMA-PORT-MATRIX.md").unwrap();
...
```bash
git add docs/specs/S/S4/S4i-PLEROMA-PORT-MATRIX.md docs/plans/2026-03-07-s4-prime-pleroma-real-port-plan.md epi-cli/tests/agent_docs.rs
...
```bash
git add docs/plans/2026-03-07-s4-prime-pleroma-real-port-plan.md epi-cli/tests/agent_docs.rs
