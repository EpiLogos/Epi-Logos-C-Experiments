...
**Files:**
- Create: `docs/plans/2026-03-06-epi-skills-system-design.md`
...
Run: `rg -n "discovery|override|multi-agent|hook|command|skill" docs/plans/2026-03-06-epi-skills-system-design.md`
Expected: Matches for every core design axis.

**Step 5: Commit**

```bash
git add docs/plans/2026-03-06-epi-skills-system-design.md
...
Plan complete and saved to `docs/plans/2026-03-06-s4-pi-agent-foundation.md`. Two execution options:
