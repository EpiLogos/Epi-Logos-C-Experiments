...
>
> **Reads together with:**
> - `docs/plans/2026-03-10-nara-runtime-full-plan.md` (v2.1) — 12-phase backend plan
> - `docs/specs/M/2026-03-11-hypertile-portal-design.md` — TUI portal spec
> - `docs/specs/M/M4-nara-subtle-body-map.md` — frontend subtle body spec
...
See `docs/specs/M/2026-03-11-hypertile-portal-design.md` for full portal spec.
...
> **Canonical spec:** `docs/specs/L/L-coordinate-system.md`
...
**Companion plan:** `docs/plans/2026-03-12-m0-relational-depth-and-archetype-completeness.md`
...
The 12 L-coordinates use **canonical names** (source: `docs/specs/L/L-coordinate-system.md`):
