# M-Dev Context Pack - 03.T6

Generated: 2026-06-01T23:54:08.603Z

## Task

- **ID:** 03.T6
- **Title:** Graphiti runtime compatibility and temporal reference bridge
- **Track:** 03-s3-gateway-and-spacetimedb.md
- **Computed status:** in_progress
- **Write scopes:** Body/S/S0/epi-cli/src/gate/**, Body/S/S3/**, Body/S/S3/graphiti-runtime
...
- `Body/S/S3/gateway/Cargo.toml`
- `Body/S/S3/graphiti-runtime`
- `Body/S/S3/graphiti-runtime/Cargo.toml`
