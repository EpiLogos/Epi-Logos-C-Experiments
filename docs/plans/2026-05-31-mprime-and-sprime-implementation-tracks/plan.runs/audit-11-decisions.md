...
- `docs/plans/2026-05-31-mprime-and-sprime-implementation-tracks/11-open-architectural-decisions.md` — status updates only (resolutions log + 5 status lines + 5 index-row updates + 1 tranche-wave-0 update).
- `docs/plans/2026-05-31-mprime-and-sprime-implementation-tracks/plan.runs/audit-11-decisions.md` — this file.
