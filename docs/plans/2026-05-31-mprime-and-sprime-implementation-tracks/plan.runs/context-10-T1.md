# M-Dev Context Pack - 10.T1

Generated: 2026-06-01T23:35:30.747Z

## Task

- **ID:** 10.T1
- **Title:** S0/S3 Live Profile Stream MVP
...
- 01.T0 - Baseline Contract Inventory (01-kernel-bridge-and-s0-foundation.md)
- 01.T1 - C Pointer Authority And FFI Hardening (01-kernel-bridge-and-s0-foundation.md)
- 01.T2 - `MathemeHarmonicProfile` Completion And Versioning (01-kernel-bridge-and-s0-foundation.md)
- 01.T3 - S0' CLI, Schema, And Gateway Profile Surface (01-kernel-bridge-and-s0-foundation.md)
- 01.T4 - SpaceTimeDB Projection And Resync Bridge (01-kernel-bridge-and-s0-foundation.md)
- 03.T1 - Projection contract freeze and readiness surface (03-s3-gateway-and-spacetimedb.md)
- 03.T2 - Gateway WebSocket multiplexer and RPC parity guard (03-s3-gateway-and-spacetimedb.md)
- 03.T3 - Native SpaceTimeDB WebSocket subscription completion (03-s3-gateway-and-spacetimedb.md)
- 03.T4 - Shared-cosmos tables and scheduled reducers (03-s3-gateway-and-spacetimedb.md)
- 10.T0 - Integration Decision Gate And Local Harness Topology (10-cross-cutting-integration-and-milestones.md)
