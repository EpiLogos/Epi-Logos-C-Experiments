...
**Source plan:** `docs/plans/2026-05-31-mprime-and-sprime-implementation-tracks/04-s5-autoresearch-and-review-extension.md`
...
- **writeScopes (per plan.index.json):** `Body/S/S5/**` and `docs/specs/S/S5-S5i-SYNC.md`. The latter is currently a 181-line STUB ("`epi-cli/src/sync/mod.rs` — stub only") — T9 needs to update its "Implementation Plan" section to reference the live S5-core spine even though Notion/n8n/world sync execution remains future work.
