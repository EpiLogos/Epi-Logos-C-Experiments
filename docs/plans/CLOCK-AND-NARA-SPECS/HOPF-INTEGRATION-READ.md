...
2. `docs/specs/M/2026-03-12-cosmic-clock-full-architecture.md` — clock node topology
3. `docs/plans/CLOCK-AND-NARA-SPECS/00-canonical-invariants.md` — primitives contract
4. `docs/plans/CLOCK-AND-NARA-SPECS/13-shadow-decans-rotational-states.md` — rotational states
5. `docs/plans/CLOCK-AND-NARA-SPECS/02-16-lenses-backbone-temporal.md` — lens system
6. `docs/plans/CLOCK-AND-NARA-SPECS/dataset-bridge/03-mahamaya-findings.md` — codon data
