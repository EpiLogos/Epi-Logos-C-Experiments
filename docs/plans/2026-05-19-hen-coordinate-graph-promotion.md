...
- `docs/specs/S/S1-S1i-OBSIDIAN.md`
- `docs/specs/S/S2-S2i-GRAPH.md`
- `docs/plans/2026-03-07-s1-s2-implementation-plan.md`
...
```bash
git add Body/S/S2/graph-schema/src/lib.rs Body/S/S2/graph-schema/tests/relationship_registry.rs docs/specs/S/S2-S2i-GRAPH.md
...
```bash
git add repo-ontology.md docs/specs/S/S1-S1i-OBSIDIAN.md docs/specs/S/S2-S2i-GRAPH.md docs/plans/2026-03-07-s1-s2-implementation-plan.md docs/dev/architecture/depwire/CURRENT.md docs/plans/2026-03-07-s3-electron-verification-notes.md
