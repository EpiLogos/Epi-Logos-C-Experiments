...
```bash
git add epi-cli/tests/gate_electron_controller_compat.rs epi-cli/tests/gate_omnipanel_contract.rs docs/specs/S/S4-S4i-PI-AGENT.md docs/dev/pi-operator-protocol.md .pi/extensions/ta-onta/anima/CONTRACT.md .pi/extensions/ta-onta/pleroma/CONTRACT.md
