...
**Paired with:** `docs/specs/M/2026-03-12-cosmic-clock-full-architecture.md` + `docs/plans/2026-03-10-nara-runtime-full-plan.md`
...
- `docs/plans/M1-C-architecture.md`: coordinate `#1-3-4.5/0` (Transcendent Integration / Recursive Frame)
- `docs/specs/M/M0-anuttara-language-architecture.md`: coordinate `#0-4.5/0` (# — Nara Base)
...
- [ ] Read M5 Epii design doc (`docs/plans/2026-03-07-m5-epii-design.md`) with the 6-stage Logos FSM
