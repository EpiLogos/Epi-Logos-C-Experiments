...
- `docs/specs/S/S4/S4-EXTENSION-ARCHITECTURE.md` — canonical 3-layer model
- `docs/specs/S/S4/S4-TA-ONTA-EXTENSION-SPEC.md` — inner structure per module
- `docs/specs/S/S4/S4-NOW-INTEGRATION-AND-ENVIRONMENT.md` — NOW thread, vault topology
- `docs/specs/S/S4/S4-S4i-PI-SKILLS-AND-PLUGIN-SYSTEM.md` — plugin/skill/subagent contracts
