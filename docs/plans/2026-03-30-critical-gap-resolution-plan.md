...
**Spec:** Full specification in `docs/plans/CLOCK-AND-NARA-SPECS/09-cosmic-clock-plugin-tui-spec.md`
...
**Spec:** Full specification in `docs/plans/CLOCK-AND-NARA-SPECS/15-m2-vibrational-matrix-portal-plugin.md`
...
**Spec:** Full specification in `docs/plans/CLOCK-AND-NARA-SPECS/14-m3-knowing-dossier-portal-plugin.md`
