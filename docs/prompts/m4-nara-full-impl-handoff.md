...
```
CANONICAL PLANS:
1.  docs/plans/2026-03-11-m-branch-nara-integration-clarity.md   ← MASTER plan, all 14 parts
2.  docs/plans/2026-03-10-nara-runtime-full-plan.md              ← backend v2.1, all phases + structs
3.  docs/specs/M/2026-03-11-hypertile-portal-design.md           ← TUI portal spec, 17 plugins
...
19. docs/datasets/nara-deep/nodes-full-detail.json      ← 99 M4 nodes
20. docs/datasets/nara-deep/relations.json              ← 169 relation types
21. docs/datasets/parashakti-deep/parashakti-planets.json  ← planet nodes
22. docs/plans/2026-03-11-m-branch-nara-integration-clarity.md  ← Part XIV has the Parashakti
...
Implement exactly as specified in `docs/plans/2026-03-10-nara-runtime-full-plan.md` Section II:
...
Implement all four modules. Each is fully specified in `docs/plans/2026-03-10-nara-runtime-full-plan.md` Section X-B and the master clarity plan:
