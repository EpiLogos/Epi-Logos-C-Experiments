...
MAHAMAYA_NODES = os.path.join(REPO_ROOT, "docs/datasets/mahamaya-deep/nodes-full-detail.json")
MAHAMAYA_RELS  = os.path.join(REPO_ROOT, "docs/datasets/mahamaya-deep/relations.json")
