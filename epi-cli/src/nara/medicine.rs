...
pub static ZODIAC_DECAN_TABLE: [ZodiacDecanEntry; 36] = [
    ...
    ZodiacDecanEntry { sign: 0, decan_in_sign: 0, ruling_planet: 7, element: 2, mode: 0,
        ananda_harmonic: 0,  // DR(0×7=0)
        body_part: "Skull and brain - the command center of action",
        herb:      "Hawthorn" },
    ZodiacDecanEntry { sign: 0, decan_in_sign: 1, ruling_planet: 0, element: 2, mode: 0,
        ananda_harmonic: 0,  // DR(0×0=0)
        body_part: "Eyes and sinuses - the vision centers",
        herb:      "Nettle" },
    ZodiacDecanEntry { sign: 0, decan_in_sign: 2, ruling_planet: 2, element: 2, mode: 0,
    ...
    ZodiacDecanEntry { sign: 1, decan_in_sign: 0, ruling_planet: 3, element: 4, mode: 1,
        ananda_harmonic: 3,  // DR(1×3=3)
        body_part: "Throat and vocal cords - instruments of manifestation",
        herb:      "Alfalfa" },
    ZodiacDecanEntry { sign: 1, decan_in_sign: 1, ruling_planet: 4, element: 4, mode: 1,
        ananda_harmonic: 4,  // DR(1×4=4)
        body_part: "Upper chest and lungs - breath of life",
        herb:      "Barley" },
    ZodiacDecanEntry { sign: 1, decan_in_sign: 2, ruling_planet: 5, element: 4, mode: 1,
    ...
    ZodiacDecanEntry { sign: 2, decan_in_sign: 0, ruling_planet: 6, element: 1, mode: 2,
        ananda_harmonic: 3,  // DR(2×6=12→3)
        body_part: "Hands and fingers - tools of communication",
        herb:      "Lavender" },
    ZodiacDecanEntry { sign: 2, decan_in_sign: 1, ruling_planet: 7, element: 1, mode: 2,
        ananda_harmonic: 5,  // DR(2×7=14→5)
        body_part: "Lungs and diaphragm - breath of action",
        herb:      "Frankincense" },
    ZodiacDecanEntry { sign: 2, decan_in_sign: 2, ruling_planet: 0, element: 1, mode: 2,
    ...
    ZodiacDecanEntry { sign: 3, decan_in_sign: 0, ruling_planet: 2, element: 3, mode: 0,
        ananda_harmonic: 6,  // DR(3×2=6)
        body_part: "Breasts and stomach - centers of nurturing",
        herb:      "Jasmine" },
    ZodiacDecanEntry { sign: 3, decan_in_sign: 1, ruling_planet: 3, element: 3, mode: 0,
        ananda_harmonic: 9,  // DR(3×3=9) — pivotal mystery point
        body_part: "Upper digestive system and ribs",
        herb:      "Water Lily" },
    ZodiacDecanEntry { sign: 3, decan_in_sign: 2, ruling_planet: 4, element: 3, mode: 0,
    ...
    ZodiacDecanEntry { sign: 4, decan_in_sign: 0, ruling_planet: 5, element: 2, mode: 1,
        ananda_harmonic: 2,  // DR(4×5=20→2)
        body_part: "Heart and spine - core of strength",
        herb:      "Sunflower" },
    ZodiacDecanEntry { sign: 4, decan_in_sign: 1, ruling_planet: 6, element: 2, mode: 1,
        ananda_harmonic: 6,  // DR(4×6=24→6)
        body_part: "Upper back and circulation",
        herb:      "Marigold" },
    ZodiacDecanEntry { sign: 4, decan_in_sign: 2, ruling_planet: 7, element: 2, mode: 1,
    ...
    ZodiacDecanEntry { sign: 5, decan_in_sign: 0, ruling_planet: 0, element: 4, mode: 2,
        ananda_harmonic: 0,  // DR(5×0=0)
        body_part: "Intestines and digestive system",
        herb:      "Wheat" },
    ZodiacDecanEntry { sign: 5, decan_in_sign: 1, ruling_planet: 2, element: 4, mode: 2,
        ananda_harmonic: 1,  // DR(5×2=10→1)
        body_part: "Spleen and pancreas",
        herb:      "Mint" },
    ZodiacDecanEntry { sign: 5, decan_in_sign: 2, ruling_planet: 3, element: 4, mode: 2,
    ...
    ZodiacDecanEntry { sign: 6, decan_in_sign: 0, ruling_planet: 4, element: 1, mode: 0,
        ananda_harmonic: 6,  // DR(6×4=24→6)
        body_part: "Kidneys and lower back",
        herb:      "Chamomile" },
    ZodiacDecanEntry { sign: 6, decan_in_sign: 1, ruling_planet: 5, element: 1, mode: 0,
        ananda_harmonic: 3,  // DR(6×5=30→3)
        body_part: "Bladder and skin",
        herb:      "Myrrh" },
    ZodiacDecanEntry { sign: 6, decan_in_sign: 2, ruling_planet: 6, element: 1, mode: 0,
    ...
    ZodiacDecanEntry { sign: 7, decan_in_sign: 0, ruling_planet: 7, element: 3, mode: 1,
        ananda_harmonic: 4,  // DR(7×7=49→13→4)
        body_part: "Genitals and reproductive system",
        herb:      "Mandrake" },
    ZodiacDecanEntry { sign: 7, decan_in_sign: 1, ruling_planet: 0, element: 3, mode: 1,
        ananda_harmonic: 0,  // DR(7×0=0)
        body_part: "Colon and prostate",
        herb:      "Wormwood" },
    ZodiacDecanEntry { sign: 7, decan_in_sign: 2, ruling_planet: 2, element: 3, mode: 1,
    ...
    ZodiacDecanEntry { sign: 8, decan_in_sign: 0, ruling_planet: 3, element: 2, mode: 2,
        ananda_harmonic: 6,  // DR(8×3=24→6)
        body_part: "Hips and thighs",
        herb:      "Sagebrush" },
    ZodiacDecanEntry { sign: 8, decan_in_sign: 1, ruling_planet: 4, element: 2, mode: 2,
        ananda_harmonic: 5,  // DR(8×4=32→5)
        body_part: "Liver and sciatic nerve",
        herb:      "Juniper" },
    ZodiacDecanEntry { sign: 8, decan_in_sign: 2, ruling_planet: 5, element: 2, mode: 2,
    ...
    ZodiacDecanEntry { sign: 9, decan_in_sign: 0, ruling_planet: 6, element: 4, mode: 0,
        ananda_harmonic: 9,  // DR(9×6=54→9) — full saturation
        body_part: "Knees and joints",
        herb:      "Comfrey" },
    ZodiacDecanEntry { sign: 9, decan_in_sign: 1, ruling_planet: 7, element: 4, mode: 0,
        ananda_harmonic: 9,  // DR(9×7=63→9) — full saturation
        body_part: "Bones and skin",
        herb:      "Thistle" },
    ZodiacDecanEntry { sign: 9, decan_in_sign: 2, ruling_planet: 0, element: 4, mode: 0,
    ...
    ZodiacDecanEntry { sign: 10, decan_in_sign: 0, ruling_planet: 2, element: 1, mode: 1,
        ananda_harmonic: 2,  // DR(10×2)=shadow_row1[2]=2
        body_part: "Ankles and calves",
        herb:      "Horehound" },
    ZodiacDecanEntry { sign: 10, decan_in_sign: 1, ruling_planet: 3, element: 1, mode: 1,
        ananda_harmonic: 3,  // DR(10×3)=shadow_row1[3]=3
        body_part: "Circulatory system and shins",
        herb:      "Eyebright" },
    ZodiacDecanEntry { sign: 10, decan_in_sign: 2, ruling_planet: 4, element: 1, mode: 1,
    ...
    ZodiacDecanEntry { sign: 11, decan_in_sign: 0, ruling_planet: 5, element: 3, mode: 2,
        ananda_harmonic: 1,  // DR(11×5)=shadow_row2[5]=1 — unity from dissolution
        body_part: "Feet and toes",
        herb:      "Kelp" },
    ZodiacDecanEntry { sign: 11, decan_in_sign: 1, ruling_planet: 6, element: 3, mode: 2,
        ananda_harmonic: 3,  // DR(11×6)=shadow_row2[6]=3
        body_part: "Lymphatic system",
        herb:      "Lotus" },
    ZodiacDecanEntry { sign: 11, decan_in_sign: 2, ruling_planet: 7, element: 3, mode: 2,
...
pub static CHAKRA_BODY_ZONES: [&[&str]; 8] = [
    ...
    &["physical_ground", "biosphere", "geomagnetic_field", "schumann_resonance"],
...
pub fn prescribe(context: &str, is_shadow: bool) -> Result<String, String> {
    ...
    let ruling_planet_id = zodiac_decan(decan)
        .map(|d| d.ruling_planet)
        .unwrap_or(0);
...
pub fn chakra(json: bool) -> Result<String, String> {
    ...
    let decan_chakra = zodiac_decan(decan)
        .map(|d| PLANET_CHAKRA.get(d.ruling_planet as usize).copied().unwrap_or(0))
        .unwrap_or(0);
...
pub fn materia(json: bool) -> Result<String, String> {
    ...
    let entry = zodiac_decan(decan)
        .ok_or_else(|| format!("Invalid decan index: {}", decan))?;
    ...
    let chakra_id = PLANET_CHAKRA.get(entry.ruling_planet as usize).copied().unwrap_or(0);
    let chakra_nm = chakra_name(chakra_id);
