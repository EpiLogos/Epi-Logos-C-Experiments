...
use epi_logos::graph::semantic_cache::{
    SearchPayload, SemanticCacheClient, SemanticCacheConfig, SemanticCacheHealth,
...
async fn semantic_cache_python_bridge_round_trip() {
    ...
    std::env::set_var(
        "EPILOGOS_SEMANTIC_CACHE_SCRIPT",
        "/Users/admin/Documents/Epi-Logos C Experiments/epi-cli/scripts/redisvl_cache_service/redisvl_cache_service.py",
    );
    std::env::set_var(
        "EPILOGOS_SEMANTIC_CACHE_PYTHON",
        "/Users/admin/Documents/Epi-Logos C Experiments/epi-cli/scripts/redisvl_cache_service/.venv/bin/python3",
    );
