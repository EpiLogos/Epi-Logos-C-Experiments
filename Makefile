...
$(TEST_BIN_DIR)/test_m2_aspects: $(LIB_SRC) epi-lib/test/m2/test_m2_aspects.c | $(TEST_BIN_DIR)
	$(CC) $(CFLAGS) $(BLAKE3) $(SANFLAGS) -o $@ $^ -lm
...
$(TEST_BIN_DIR)/test_m3_codon_class: $(LIB_SRC) epi-lib/test/m3/test_m3_codon_class.c | $(TEST_BIN_DIR)
	$(CC) $(CFLAGS) $(BLAKE3) $(SANFLAGS) -o $@ $^
...
$(TEST_BIN_DIR)/test_m4_oracle_faces: $(LIB_SRC) epi-lib/test/m4/test_m4_oracle_faces.c | $(TEST_BIN_DIR)
	$(CC) $(CFLAGS) $(BLAKE3) $(SANFLAGS) -o $@ $^ -lm
...
$(TEST_BIN_DIR)/test_engine_walk_mode: $(LIB_SRC) epi-lib/test/test_engine_walk_mode.c | $(TEST_BIN_DIR)
	$(CC) $(CFLAGS) $(BLAKE3) $(SANFLAGS) -o $@ $^ -lm
